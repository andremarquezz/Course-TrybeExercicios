...
const generatorNumber = () => (number = Math.floor(Math.random() * 6))
const comparaNumero = (numero) => numero === generatorNumber() ? 'Parabéns você ganhou' : 'Tente novamente';
const sorteio = (callback, numero) => {
